...
def create_cover():
    ...
    draw.text((100, PAGE_H - 95), "ГАСК № 19011889 (II категория)", fill=TEXT_WHITE, font=FONT_BODY)
...
def create_contacts(page_num, total_pages):
    ...
    contacts = [
        ...
        ("ОФИС В АЛМАТЫ", "Республика Казахстан, г. Алматы, 12 мкрн, дом 22/2"),
    ...
    points = [
        ...
        "✓ Проектирование по государственной лицензии II категории",
